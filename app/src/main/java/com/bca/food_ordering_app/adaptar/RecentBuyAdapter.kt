...
import com.bca.food_ordering_app.databinding.RecentBuyItemBinding
...
class RecentBuyAdapter(
    ...
    private var foodQuantitiesList: ArrayList<Int>,
    ...
    inner class RecentViewHolder(
        ...
        fun bind(position: Int) {
            binding.apply {
                ...
                foodQuantity.text = foodQuantitiesList[position].toString()
            }
        }
